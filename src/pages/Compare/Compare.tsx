                  ...
                  <table className="table table-bordered text-center">
                    <tbody>
                      <tr className="pr_image">
                        <td className="row_title">Product Image</td>
                        {
                          comparelists.map((product: Product)=>{
                            return <td key={product._id} className="row_img">
                      ...
                      <tr className="pr_title">
                        ...
                        {
                          comparelists.map((product: Product)=>{
                            return  <td key={product._id} className="product_name">
                      ...
                      <tr className="pr_price">
                        ...
                        {
                          comparelists.map((product: Product)=>{
                            return  <td key={product._id} className="product_price">
                      ...
                      <tr className="pr_add_to_cart">
                        ...
                        {
                          comparelists.map((product: Product)=>{
                            return  <td key={product._id} className="row_btn">
                      ...
                      <tr className="description">
                        ...
                        {
                          comparelists.map((product: Product)=>{
                            return  <td key={product._id} className="row_text">
                      ...
                      <tr className="pr_remove">
                        ...
                        {
                          comparelists.map((product: Product)=>{
                            return  <td key={product._id} className="row_remove">
